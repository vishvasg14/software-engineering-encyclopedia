...
### 4.3 The CMS era and the rise of tuning culture (2006–2014)
...
### 4.4 The modular, post-Oracle era (2014–2021)
...
### 4.7 Garbage collector lineage at a glance
...
### 6.3 Game servers and real-time systems
...
### 6.6 Why not a different runtime?
...
### 7.3 From source to executing code
...
### 8.1 Bytecode and the class file format
...
### 8.5 Garbage collection — the algorithm taxonomy
...
### 8.10 Virtual threads (Project Loom)
...
### 10.1 Time complexity of major operations
...
### 11.6 Common JVM-specific attacks
...
### 12.1 How the JVM is used in production
...
### 13.1 Netflix — G1 to ZGC migration
...
### 13.2 Meta — large-scale ZGC rollout
...
### 13.3 Twitter / X — original allocation pressure saga
...
### 13.4 High-frequency trading — microsecond budgets
...
### 13.5 Online gaming — Minecraft / Roblox
...
### 13.6 Apache Kafka — Throughput-oriented GC choice
...
### 14.1 Disassembling bytecode with `javap`
...
### 14.2 JFR scripting for allocation hot spots
...
### 14.3 Reproducing a safepoint-induced pause
...
### 14.4 Virtual thread pinning demo (Java 21)
...
### 14.5 Native memory leak with NIO
...
### 14.6 Bad, anti-pattern, refactored, performance-optimized, secure, and thread-safe variants
...
### 17.8 Cloud monitoring equivalents
...
### 20.4 Container CPU quota vs JIT compiler threads
...
### 20.5 Huge pages disabled by the kernel
...
### 20.8 `Reflection.getCallerClass()` in modules
...
### 20.11 Process reaper in containers
...
### 20.12 Random source slowness on startup
...
### 20.15 Distributed system failures
...
### 21.4 G1 vs ZGC vs Shenandoah vs Parallel
...
### 21.5 Tiered vs AOT compilation
...
### 23.8 Diagnostic Tool Documentation
