...
### 4.6 The cloud-native era (2020s)
...
### 6.1 PostgreSQL at hyperscalers
...
### 7.1 The lifecycle of a SQL query
...
### 7.3 Subsystems that participate
...
### 8.12 MVCC — Multi-Version Concurrency Control
...
### 8.13 VACUUM and tuple lifecycle
...
### 8.14 Transaction ID wraparound
...
sequenceDiagram
    ...
    Note over Disk: Later. Background writer flushes data page to disk.<br/>WAL can be truncated after checkpoint.
...
### 9.1 PostgreSQL high-level architecture
...
### 9.4 MVCC implementation details
...
### 12.1 How PostgreSQL is used in production
...
### 12.2 Real architecture (typical Kubernetes + PostgreSQL)
...
### 12.4 High availability with Patroni
...
### 12.9 Failover and disaster recovery
...
### 13.1 Instagram — PostgreSQL at extreme scale
...
### 13.2 WhatsApp — Erlang + PostgreSQL
...
### 13.3 Uber — schemaless to PostgreSQL
...
### 13.4 Stripe — PostgreSQL as a service
...
### 13.5 GitLab — large-scale PG operations
...
### 13.6 Cloudflare — PostgreSQL for analytics
...
### 13.7 Discord — trillions of messages
...
### 13.8 Notion — PostgreSQL as foundation
...
### 14.5 CTEs and recursive queries
...
### 14.6 Transactions and isolation
...
### 14.13 Bad, anti-pattern, refactored, secure, performance-optimized examples
...
### 16.10 Production troubleshooting checklist
...
### 19.7 Storing passwords in plain text
...
### 20.1 Transaction ID wraparound
...
### 20.6 Prepared statement plan invalidation
...
### 20.9 `MERGE` and concurrent updates
...
### 20.10 Logical replication slot retention
...
### 20.12 Bloat on heavily-updated tables
...
### 21.1 PostgreSQL vs MySQL vs MongoDB vs Redis
...
### 23.6 PostgreSQL internal documentation
