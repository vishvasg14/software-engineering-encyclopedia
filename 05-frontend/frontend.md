...
### 5.1 What Angular solved (and what the ecosystem solved before it)
...
### 5.2 Why Angular for an enterprise?
...
### 5.3 What Angular is criticized for
...
### 7.1 The lifecycle of an Angular application
...
### 9.1 Angular framework layering
...
### 9.2 Module / standalone component tree
...
### 12.1 How Angular is used in production
...
### 12.11 Migration: NgModule to Standalone
...
### 13.3 Deutsche Bank — Digital Banking Platform
...
### 13.5 McDonald's — Ordering Platform
...
### 14.9 Bad, anti-pattern, refactored, secure, performance-optimized, and reactive examples
...
### 16.4 Common debugging commands
...
### 16.5 Detecting subscription leaks
...
### 19.2 Mutating state outside the framework
...
### 19.3 Subscribing without cleanup
...
### 19.5 Service with global state
...
### 19.7 String-based style/class binding
...
### 20.1 Signals + OnPush interaction
...
### 21.2 Signals vs React useState
